    ...
    function AgregaVentas () {
            ...
            if (caja == "") {
                ...
                var nuevaFila =
                    "<tr align='center'>" +
                        "<td>" +
                        '<button class="btn btn-info btn-sm" style="cursor:pointer;border-radius:5px 5px 5px 5px;" onclick="addItem(' +
                        "'" + item.txtCodigo + "'," +
                        "'-1'," +
                        "'" + item.producto + "'," +
                        "'" + item.marcas + "'," +
                        ...
                        "<td align='left'><abbr title='MARCA (" + item.marcas + ") - MODELO (" + (item.modelos == '' ? '****' : item.modelos) + ")'><h6>" + item.producto + "</h6></td>" +
                        "<td>" + item.precio2 + "</td>" +
...
function addItem(codigo, cantidad, producto, marcas, modelos, precio, precio2, descproducto, ivaproducto, existencia, precioconiva, opCantidad) {
