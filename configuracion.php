        ...
        <div class="card">
           ...
           <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        <label class="control-label">Seleccione Moneda Nacional: </label>
                        <i class="fa fa-bars form-control-feedback"></i>
             ...
             <div class="row">
              ...
              <div class="col-md-3">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                      ...
                      <a href="#" class="btn btn-dark fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times-circle"></i> Remover</a><small><p>Para Subir el Logo #1 para reportes Pdf debe tener en cuenta:<br> * La Imagen debe ser extension.png<br> * La imagen no debe ser mayor de 200 KB</p></small>                             </div>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 90px; height: 110px;">
                        <?php if (file_exists("fotos/logo-pdf2.png")){
                            echo "<img src='fotos/logo-pdf2.png' class='img-rounded' border='0' width='90' height='110' title='Logo' data-rel='tooltip'>"; 
                        } else {
                            echo "<img src='fotos/ninguna.png' class='img-rounded' border='0' width='90' height='110' title='Sin Logo' data-rel='tooltip'>"; 
                        } ?>
                    </div>
                    <div>
                      <span class="btn btn-success btn-file">
                          <span class="fileinput-new"><i class="fa fa-file-image-o"></i> Logo Reporte #2</span>
                          <span class="fileinput-exists"><i class="fa fa-paint-brush"></i> Logo Reporte #2</span>
                          <input type="file" size="10" data-original-title="Subir Logo #3" data-rel="tooltip" placeholder="Suba su Logo #3" name="imagen3" id="imagen3"/>
                      </span>
                      <a href="#" class="btn btn-dark fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times-circle"></i> Remover</a><small><p>Para Subir el Logo #2 para Reportes Pdf debe tener en cuenta:<br> * La Imagen debe ser extension.png<br> * La imagen no debe ser mayor de 200 KB</p></small>                             </div>
                  </div>
              </div>
          </div>
