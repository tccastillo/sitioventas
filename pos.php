...
<div id="myModalCliente" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" name="clientepos" id="clientepos" action="#">
    ...
    <div class="col-lg-5">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-pencil"></i> POS Terminal</h4>
            </div>
        <form class="form form-material" method="post" action="#" name="savepos" id="savepos">
...
<!-- /.modal --> 
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback"> 
                  ...
                  <input type="text" class="form-control agregaventa" name="busquedaproductov" id="busquedaproductov" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la Búsqueda por Código, Descripción o Código de Barra">
    ...
    <td>
    <h6 class="text-right"><label>Desc. <?php echo $_SESSION['descsucursal'] ?>%:<input type="hidden" name="descuento" id="descuento" value="<?php echo $_SESSION['descsucursal'] ?>"></label></h6>
    </td>
...
<!-- End Row -->
    ...
    setTimeout(function() {
    $('#loading').load("familias_productos?ProductosxFamilias=si&url=pos");
     }, 1000);
    </script>
    <!-- jQuery -->
